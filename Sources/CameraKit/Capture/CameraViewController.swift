...
enum CaptureResolution {
    ...
    var resolutionSize: CGSize {
        return switch self {
        case .sd: CGSize(width: 480, height: 640) // 480, 576 ?
...
//    private var photoCaptureCompletion: ((Data)->Void)?
    ...
    init(captureMode: CaptureMode, cameraDirection: CameraDirection, captureResolution: CaptureResolution, videoFilter: VideoFilter = .none) {
